...
if ( !class_exists( 'woolive_ajax_search_widget_class' ) ) {
    class woolive_ajax_search_widget_class extends WP_Widget {
        public function __construct() {
            ...
            parent::__construct( 'wooliveTitleWidget', __( 'Ajax Live Search Product', 'awas-woo' ), $widget_ops );
        }
        public function form( $instance ) {
            $title = isset( $instance['title'] ) ? $instance['title'] : __( 'Live Search Product', 'awas-woo' );
            ?>
            <p>
